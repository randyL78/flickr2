...
const SearchStateless = props =>  {
  let searchField;
  return (
    <Form className="search-F" onSubmit={ e => props.handleSubmit(e, searchField, props.history) }>
      <SearchInput type="search" name="search" placeholder="Search" required innerRef={ input => searchField = input} />
